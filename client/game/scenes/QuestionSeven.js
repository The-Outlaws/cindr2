...
export default class QuestionSeven extends Phaser.Scene {
  constructor() {
    super({ key: 'QuestionSeven' });
  }
  ...
  create() {
    ...
    this.add.text(
      ...
      `Question #7 Lorem ipsum dolor sit amet, consectetur adipiscing elit `,
      fontStyleQuestion
    );
    this.answerA = this.add.text(
      3.62 * this.bg.displayWidth / 4,
      2.8 * this.bg.displayHeight / 4,
      'Answer in #7 Lorem ipsum dolor sit amet, consectetur adipiscing elit',
      fontStyleAnswer
    );
    ...
    this.physics.add.collider(
      ...
      this.physicsObjectA,
      () => {
        this.scene.start('QuestionTwelve');
      },
      null,
      this
    );
    ...
    this.physics.add.collider(
      ...
      this.physicsObjectB,
      () => {
        this.scene.start('QuestionThirteen');
      },
      null,
      this
    );
