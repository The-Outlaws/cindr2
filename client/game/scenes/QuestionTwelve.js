...
export default class QuestionTwelve extends Phaser.Scene {
  constructor() {
    super({ key: 'QuestionTwelve' });
  }
  ...
  create() {
    ...
    this.add.text(
      ...
      `Question #12 Lorem ipsum dolor sit amet, consectetur adipiscing elit `,
      fontStyleQuestion
    );
    this.answerA = this.add.text(
      3.62 * this.bg.displayWidth / 4,
      2.8 * this.bg.displayHeight / 4,
      'Answer in #12 Lorem ipsum dolor sit amet, consectetur adipiscing elit',
      fontStyleAnswer
    );
