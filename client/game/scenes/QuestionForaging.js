...
export default class QuestionForaging extends Phaser.Scene {
  constructor() {
    super({ key: 'QuestionForaging' });
  }
  ...
  create() {
    ...
    this.add.text(
      ...
      `You didn't find any, but spiders found you. You:`,
      fontStyleQuestion
    );
