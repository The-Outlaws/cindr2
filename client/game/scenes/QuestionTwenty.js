...
export default class QuestionTwenty extends Phaser.Scene {
  constructor() {
    super({ key: 'QuestionTwenty' });
  }
  ...
  preload() {
    ...
    this.load.image('smores', '/smores.jpg');
  }
  ...
  create() {
    ...
    this.physics.add.collider(
      ...
      this.physicsObjectA,
      () => {
        this.scene.start('QuestionForaging');
      },
      null,
      this
    );
